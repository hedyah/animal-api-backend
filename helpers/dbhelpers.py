...
#update the user whose usernam  is Maria and set the age to 35
run_query("UPDATE user SET age=? WHERE username=?", [35,"Maria"])

#delete a user under age of 25
run_query("DELETE from post")

users = run_query("SELECT * from user")
print(result)